...
```mermaid
flowchart TB
    F["ENRIQUE FLORES<br/>Founder · Product & Systems Architecture"]
    L["CROHNOZ LABS<br/>Technology & Product Ecosystem"]

    F --> L

    L --> P["PRODUCT & STRATEGY<br/>Discovery · Product · Domain"]
    L --> E["ENGINEERING & TRUST<br/>Software · Data · Security · Quality"]
    L --> H["HARDWARE & PROTOTYPING<br/>Integration · Electronics · 3D · Devices"]
    L --> A["AI & AUTOMATION<br/>Agents · Workflows · Intelligence"]
    L --> O["OPERATIONS & GROWTH<br/>DevOps · Delivery · FinOps · Commercial"]

    P --> D["CROSS-FUNCTIONAL DELIVERY"]
    E --> D
    H --> D
    A --> D
    O --> D
